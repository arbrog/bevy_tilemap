...
pub(super) trait Layer<T: BaseTile>: 'static {
...
pub(super) struct DenseLayer<T: BaseTile> {
    /// A mesh handle.
...
pub(super) struct SparseLayer<T: BaseTile> {
    /// A mesh handle.
    #[cfg_attr(feature = "serde", serde(skip))]
    mesh: Handle<Mesh>,
...
pub(super) enum LayerKindInner<T: BaseTile> {
...
pub(super) struct SpriteLayer<T: BaseTile> {
